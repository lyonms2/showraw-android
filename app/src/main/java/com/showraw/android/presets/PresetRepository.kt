    ...
    val all: List<Preset> = listOf(
        ...
        Preset(
            ...
            eqBands = listOf(
                ...
                EqBand(EqFilterType.PEAKING,    1000f,  0f, 0.707f),
                EqBand(EqFilterType.HIGH_SHELF, 8000f,  3f, 0.707f),
            ),
        ...
        Preset(
            ...
            eqBands = listOf(
                EqBand(EqFilterType.LOW_SHELF,   200f, -1f, 0.707f),
                EqBand(EqFilterType.PEAKING,    1000f,  2f, 1.0f),
                EqBand(EqFilterType.HIGH_SHELF, 8000f,  1f, 0.707f),
            ),
        ...
        Preset(
            ...
            eqBands = listOf(
                EqBand(EqFilterType.LOW_SHELF,   200f,  0f, 0.707f),
                EqBand(EqFilterType.PEAKING,    1000f,  0f, 0.707f),
                EqBand(EqFilterType.HIGH_SHELF, 8000f, -2f, 0.707f),
            ),
